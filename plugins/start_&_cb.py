...
async def start(client, message: Message):
    ...
    await m.edit_text("⚡")
    await asyncio.sleep(0.5)
    await m.edit_text("<code>World Fastest Bots!!!</code>")
    await asyncio.sleep(0.4)
    await m.delete()

    # Send sticker after the text sequence
    await message.reply_sticker("CAACAgUAAxkBAAEPPjlorbkeLyVovMr7ysu7hjB0HFrcuQACfRkAAql3SVT26HNOkIj0ezYE")
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton("• ᴘʀᴇᴍɪᴜᴍ •", callback_data='premiumx')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/World_Fastest_Bots'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/World_Fastest_Bots')],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/World_Fastest_Bots'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
            ])
        )
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/World_Fastest_Bots')]
            ])
        )
        ...
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/World_Fastest_Bots')]
            ])
        )
    elif data == "plans":
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴄʟᴏsᴇ", callback_data="close"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/World_Fastest_Bots')]
            ])
        )
    elif data == "about":
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/World_Fastest_Bots'), InlineKeyboardButton("ᴄᴏᴍᴍᴀɴᴅs •", callback_data="help")],
                [InlineKeyboardButton("• ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/World_Fastest_Bots'), InlineKeyboardButton("ɴᴇᴛᴡᴏʀᴋ •", url='https://t.me/World_Fastest_Bots')],
...
async def donation(client, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url='https://t.me/World_Fastest_Bots')]
    ])
    yt = await message.reply_photo(photo='https://t.me/World_Fastest_Bots', caption=Txt.DONATE_TXT, reply_markup=buttons)
...
async def getpremium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("• ᴘʟᴀɴs •", callback_data='plans')],
        [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/World_Fastest_Bots"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
...
async def premium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("sᴇɴᴅ ss", url="https://t.me/World_Fastest_Bots"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
